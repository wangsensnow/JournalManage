...
//        }
    ...
    private static Map<String, CellStyle> createStyles(Workbook wb) {
        ...
        style.setBorderBottom(BORDER_DOTTED);
        ...
        style = wb.createCellStyle();
        style.setAlignment(ALIGN_LEFT);
        style.setFont(itemFont);
        styles.put("item_left", style);

        style = wb.createCellStyle();
        style.setAlignment(ALIGN_RIGHT);
        style.setFont(itemFont);
        ...
        style.setAlignment(ALIGN_RIGHT);
        style.setFont(itemFont);
        style.setBorderRight(BORDER_DOTTED);
        style.setRightBorderColor(IndexedColors.GREY_40_PERCENT.getIndex());
        style.setBorderBottom(BORDER_DOTTED);
        style.setBottomBorderColor(IndexedColors.GREY_40_PERCENT.getIndex());
        style.setBorderLeft(BORDER_DOTTED);
        style.setLeftBorderColor(IndexedColors.GREY_40_PERCENT.getIndex());
        style.setBorderTop(BORDER_DOTTED);
    ...
    public static void createNames(Workbook wb) {
        ...
        name.setRefersToFormula("IF(Loan_Amount*Interest_Rate*Loan_Years*Loan_Years>0,true,false)");
    }
}
